...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/robast/pkg/RandVar/inst/doc/RandVar.Rnw $}
{$LastChangedDate: 2009-03-24 14:44:09 +0100 (Di, 24 Mrz 2009) $}
